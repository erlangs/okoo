...
with `github.com/erlangs/okoo-demo` as path.
...
----
Modules = [
    "github.com/erlangs/okoo-demo/openacademy",
...
- `github.com/hexya-erp/h` is the package used to get model instances which are the entry point to accessing data.
- `github.com/hexya-erp/m` mainly defines the types of record sets and record data objects.
- `github.com/hexya-erp/q` is the query builder package of Hexya.
